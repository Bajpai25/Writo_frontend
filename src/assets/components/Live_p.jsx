...
function Live_p() {
  ...
  return (
    <div>
      <h1 className='text-3xl font-serif font-semibold m-4 pl-8 p-6'>Physics</h1>
      <div className='border-gray-300  border-2 rounded-md w-3/4  h-auto m-auto'>
        ...
        <img src={i2} className='w-[233px] h-[233px] mt-4'></img>
        <div className='flex flex-col  gap-6 p-2'>
        <p className='flex flex-row gap-4 font-serif text-lg'><h1 className='font-semibold '>Name: </h1> Sagnik Dutta</p>
        <div className='flex flex-row  gap-4'>
          <button className='text-md rounded-md  bg-white p-1 w-24 text-[#ED7E0A] bg-gray-100 p-1  font-serif font-medium'>Physics</button>
        </div>
        <p className='flex flex-row gap-4 font-serif text-lg'><h1 className='font-semibold '>Institute: </h1> IIT Kharagpur, 2017</p>
        <p className='flex flex-row gap-4 font-serif text-lg'><h1 className='font-semibold '>About: </h1>
        Sagnik is a passionate engineer working at a<br/> MAANG company. He love for Mathematics<br/> and Physics makes him a part time tutor in<br/> his spare time. </p>
        </div>
        </div>
      </div>
      <div className='flex justify-center mt-8 mb-12'>
      <a href="https://us06web.zoom.us/j/87892887564"><button className="text-lg w-[300px] bg-gradient-to-r from-blue-900 to-blue-500 text-white font-semibold py-2 px-4 rounded-md shadow-md hover:from-blue-800 hover:to-blue-600 hover:shadow-lg transition duration-300">
