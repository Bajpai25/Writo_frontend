...
function Live_c() {
  ...
  return (
    <div>
      <h1 className='text-3xl font-serif font-semibold m-4 pl-8 p-6'>Chemistry</h1>
      <div className='border-gray-300  border-2 rounded-md w-3/4  h-auto m-auto'>
        ...
        <img src={i3} className='w-[233px] h-[233px] mt-4'></img>
        <div className='flex flex-col  gap-6 p-2'>
        <p className='flex flex-row gap-4 font-serif text-lg'><h1 className='font-semibold '>Name: </h1> Pallavi Gupta</p>
        <div className='flex flex-row  gap-4'>
          <button className='text-md rounded-md  bg-white p-1 w-24 text-[#ED7E0A] bg-gray-100 p-1  font-serif font-medium'>Chemistry</button>
        </div>
        <p className='flex flex-row gap-4 font-serif text-lg'><h1 className='font-semibold '>Institute: </h1> IIT Mandi, 2020</p>
        <p className='flex flex-row gap-4 font-serif text-lg'><h1 className='font-semibold '>About: </h1>
       Pallavi is a passionate engineer working at a<br/> MAANG company. He love for Mathematics<br/> and Physics makes him a part time tutor in<br/> his spare time. </p>
        </div>
        </div>
      </div>
      <div className='flex justify-center mt-8 mb-12'>
      <a href="https://us06web.zoom.us/j/88917564442"><button className="text-lg w-[300px] bg-gradient-to-r from-blue-900 to-blue-500 text-white font-semibold py-2 px-4 rounded-md shadow-md hover:from-blue-800 hover:to-blue-600 hover:shadow-lg transition duration-300">
  Join Zoom Meeting now
</button>
</a>
</div>
<div className='bg-[#1AB79D] md:mt-20 mt-8 mb-20 opacity-0.74 rounded-md md:w-[1000px] md:h-[380px] w-auto h-auto m-auto overflow-hidden '>
